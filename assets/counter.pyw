...
corn.update()
corn.attributes("-transparentcolor", "black")  # noqa
corn.overrideredirect(True)


# Make the window click-through
corn.update()
mainhwnd = win32gui.FindWindow(None, str(corn.title())) # noqa
...
if counter_color != "rgb":
    ...
    def update_color_titel():
        ...
        title_animation_id = corn.after(16, update_color_titel) # noqa
    update_color_titel()
...
def force_topmost2():
    corn.attributes("-topmost", True)
    corn.after(500, force_topmost2) # noqa
corn.after(100, force_topmost2) # noqa
