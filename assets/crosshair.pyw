...
toast.attributes("-transparentcolor", "#000001")  # noqa
toast.overrideredirect(True)

# Make the window click-through
toast.update()
mainhwnd = win32gui.FindWindow(None, str(toast.title())) # noqa
    ...
    def create_dot(self, main_color, outline_color, size):
        ...
        if main_color == "rgb" or outline_color == "rgb":
            ...
            def update_color_dot():
                ...
                toast.after(16, update_color_dot) # noqa
    ...
    def create_x(self, main_color, size, gap_size, width):
        ...
        if main_color == "rgb":
            ...
            def update_color():
                ...
                index_dot = (index_dot + 1) % len(self.rgb_colors)
                toast.after(16, update_color) # noqa
...
def force_topmost():
    toast.attributes("-topmost", True)
    toast.after(500, force_topmost) # noqa
toast.after(100, force_topmost) # noqa
